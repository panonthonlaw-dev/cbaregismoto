...
# --- หน้าเจ้าหน้าที่ (Teacher/Officer System) ---
    ...
    # 2. เมื่อ Login สำเร็จแล้ว (หน้า Dashboard เจ้าหน้าที่)
        ...
        # ✅ คืนค่าปุ่มออกระบบและหัวข้อแบบเดิมที่คุณครูชอบ
        c1, c2 = st.columns([8, 2])
        c1.subheader(f"👋 สวัสดี: {st.session_state.officer_name}")
        
        # ปุ่มออกระบบ (กลับมาแล้วครับ)
        if c2.button("🚪 ออกจากระบบ", type="secondary", key="logout_btn_fixed"):
        ...
        # 🚩 เรียกใช้ระบบจราจรต่อจากปุ่มออกระบบ
        traffic_module()
